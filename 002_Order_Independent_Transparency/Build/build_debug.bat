@echo off
REM ============================================================================
REM 002_Order_Independent_Transparency/Build/build_debug.bat
...
set "SCRIPT_DIR=%~dp0"
REM 本脚本在 002_Order_Independent_Transparency/Build/，仓库根在上两级
set "ROOT=%SCRIPT_DIR%..\.."
...
echo [build_debug] Target  : 002_Order_Independent_Transparency ^| %CONFIG% ^| "%SLN_PLATFORM%" -^> %OUT_PLATFORM% ^| Tracy=ON
echo.

"%MSBUILD%" "%SLN%" ^
    /t:002_Order_Independent_Transparency ^
...
set "OUT=%ROOT%\%OUT_PLATFORM%\%CONFIG%\002_Order_Independent_Transparency.exe"
echo.
echo [build_debug] OK
