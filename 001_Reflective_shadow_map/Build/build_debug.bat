@echo off
REM ============================================================================
REM 001_Reflective_shadow_map/Build/build_debug.bat
...
set "SCRIPT_DIR=%~dp0"
REM 本脚本在 001_Reflective_shadow_map/Build/，仓库根在上两级
set "ROOT=%SCRIPT_DIR%..\.."
...
echo [build_debug] Target  : 001_Reflective_shadow_map ^| %CONFIG% ^| "%SLN_PLATFORM%" -^> %OUT_PLATFORM% ^| Tracy=ON
echo.

"%MSBUILD%" "%SLN%" ^
    /t:001_Reflective_shadow_map ^
...
set "OUT=%ROOT%\%OUT_PLATFORM%\%CONFIG%\001_Reflective_shadow_map.exe"
echo.
echo [build_debug] OK
