@echo off
REM ============================================================================
REM 005_Software_Path_Tracing/Build/build_debug.bat
...
set "SCRIPT_DIR=%~dp0"
REM 本脚本在 005_Software_Path_Tracing/Build/，仓库根在上两级
set "ROOT=%SCRIPT_DIR%..\.."
...
echo [build_debug] Target  : 005_Software_Path_Tracing ^| %CONFIG% ^| "%SLN_PLATFORM%" -^> %OUT_PLATFORM% ^| Tracy=ON
echo.

"%MSBUILD%" "%SLN%" ^
    /t:005_Software_Path_Tracing ^
...
set "OUT=%ROOT%\%OUT_PLATFORM%\%CONFIG%\005_Software_Path_Tracing.exe"
echo.
echo [build_debug] OK
