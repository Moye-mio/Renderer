@echo off
REM ============================================================================
REM 006_Dynamic_Diffuse_GI/Build/build_debug.bat
...
echo [build_debug] Target  : 006_Dynamic_Diffuse_GI ^| %CONFIG% ^| "%SLN_PLATFORM%" -^> %OUT_PLATFORM% ^| Tracy=ON
echo.

"%MSBUILD%" "%SLN%" ^
    /t:006_Dynamic_Diffuse_GI ^
...
set "OUT=%ROOT%\%OUT_PLATFORM%\%CONFIG%\006_Dynamic_Diffuse_GI.exe"
echo.
echo [build_debug] OK
