@echo off
REM ============================================================================
REM 003_Toon_Shading/Build/build_debug.bat
...
set "SCRIPT_DIR=%~dp0"
REM 本脚本在 003_Toon_Shading/Build/，仓库根在上两级
set "ROOT=%SCRIPT_DIR%..\.."
...
echo [build_debug] Target  : 003_Toon_Shading ^| %CONFIG% ^| "%SLN_PLATFORM%" -^> %OUT_PLATFORM% ^| Tracy=ON
echo.
...
set "OUT=%ROOT%\%OUT_PLATFORM%\%CONFIG%\003_Toon_Shading.exe"
echo.
echo [build_debug] OK
